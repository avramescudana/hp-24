...
\vspace{10pt}
\begin{center}
    Based on \href{add link}{\color{jyured}arXiv2409.????$^\text{\tiny\faExternalLink}$} and \href{add link}{\color{jyured}arXiv2409.????$^\text{\tiny\faExternalLink}$}
\end{center}
}
...
\begin{frame}[noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[]
            \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=0.8\textwidth]{images/SchlichtingIS2016-pages-cropped.pdf}};
            \draw<1>[white, fill=white, fill opacity=0.9] (6.3,0) rectangle (\textheight+4.6cm,5.5) node[pos=0.5, anchor=center, xshift=0.03\linewidth,text width=6.8cm,align=center] {{\Large\color{palgold}\bfseries Glasma initial stage}\\[10pt]\begin{itemize}\itemsep0em 
                % \footnotesize
